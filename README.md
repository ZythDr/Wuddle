...
## I've noticed that my app is causing a false positive in Windows Defender. I do not know how to fix this for the time being... (Seems to be related to downloading SuperWoW, which is known to trigger false positives)
...
## Update: I've removed some unused bundled in packages and so on, the app still gets false positives, but less so now. Here you can see the results:
